...
//    }
    ...
    @Override
    public List<SysCheckExtend> findCompareCheck(Integer status, long proDetailId) {
        return null;
    }

    @Override
    public List<SysCheckExtend> findFinallyCheck(Integer status, long proDetailId) {
        return null;
    }
