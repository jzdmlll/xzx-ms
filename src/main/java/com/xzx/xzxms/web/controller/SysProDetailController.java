...
public class SysProDetailController {
    ...
    @ApiOperation(value = "根据项目详情ID查询项目的审核流程")
    @GetMapping(value = "findProDetailCheckByProId")
    public Message findProDetailCheckByProId(long Id){
        List<SysProDetailCheck> list = sysProDetailServiceImpl.findProDetailCheckByProId(Id);
