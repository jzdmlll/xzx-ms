...
public class SFTPUtil {
    ...
    public static void main(String[] args) throws SftpException, IOException {
        SFTPUtil sftp = new SFTPUtil("root", "jzdmlll@1217", "smalllei.cn", 22);
        File file = new File("D:\\vue\\code\\vue_shop\\src\\assets\\qq.png");
        InputStream is = new FileInputStream(file);

        System.out.println(sftp.upload("/home/images",  "qq.png", is));
